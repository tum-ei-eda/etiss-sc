...
#ifndef __ETISS_SC_UTILS_XREPORT_HPP__
#define __ETISS_SC_UTILS_XREPORT_HPP__
...
#define XREPORT_BASE(type, msg_stream) XREPORT_PLAIN_BASE(type, "@" << sc_core::sc_time_stamp() << ", " << msg_stream)

#define XREPORT_PLAIN_BASE(type, msg_stream)        \
    do                                              \
    {                                               \
...
#endif // __ETISS_SC_UTILS_XREPORT_HPP__
